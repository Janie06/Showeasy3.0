                        ...
                        CallBack: function () {
                            ...
                            $("#jsGrid").jsGrid({
                                ...
                                fields: [
                                    ...
                                    {
                                        name: "BillChanges", title: 'common.BillChanges', width: 200, itemTemplate: function (val, item) {
                                            var oBillChanges = $.parseJSON(val);
                                            return oBillChanges.ExhibitionName + '[' + oBillChanges.BillNO + ']';
                                        }
                                    },
                                    {
