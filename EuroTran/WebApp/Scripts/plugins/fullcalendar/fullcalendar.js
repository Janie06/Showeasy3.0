    ...
    */
    ...
    DayGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            return '<a tooltips class="' + classes.join(' ') + '"' +
                (event.url ?
                ...
                (event.content ?
                    ' title="' + htmlEscape(event.content) + '"' :
                    ''
                ) +
                '>' +
                        ...
                        if (buttonName == 'title') {
                            ...
                            if (buttonClick) {
                                ...
                                button = $( // type="button" so that it doesn't submit a form
                                    '<button type="button" data-id="' + (buttonName || '') + '" class="' + classes.join(' ') + '">' +
                                    innerHtml +
                                    '</button>'
                                )
                                    .click(function (ev) {
    ...
    var ListViewGrid = Grid.extend({
        ...
        fgSegHtml: function (seg) {
            ...
            return '<tr class="' + classes.join(' ') + '">' +
                ...
                '<a tooltips' + (url ? ' href="' + htmlEscape(url) + '"' : '') + '>' +
