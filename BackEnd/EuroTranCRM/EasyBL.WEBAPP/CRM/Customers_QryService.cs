            ...
            try
            {
                do
                {
                    ...
                    pml.DataList = db.Queryable<OTB_CRM_Customers, OTB_SYS_Members, OTB_CRM_CustomersMST>
                        ...
                        .WhereIF(!string.IsNullOrEmpty(sIndustry), (t1, t2) => t1.Industry.Contains(sIndustry) || t1.IndustryStatistics.Contains(sIndustry))
        ...
        public ResponseMessage QueryOne(RequestMessage i_crm)
        {
            ...
            try
            {
                do
                {
                    ...
                    var oEntity = db.Queryable<OTB_CRM_Customers>().Single(x => x.guid == sId);
