    ...
    fnPageInit = function () {
        var oCurData = { CheckOrder: [], PayeeInfo: [] },
            ...
            fnSubmitPetition = function () {
                g_api.ConnectLite(sProgramId, 'InvoiceApplyForPersonalToAudit', {
                    guid: oCurData.Guid
                }, function (res) {
                    if (res.RESULT) {
            ...
            init = function () {
                ...
                $.whenArray([
                    ...
                    fnSetArgDrop([
                        ...
                        {
                            ArgClassID: 'EipFeeType',
                            CallBack: function (data) {
                                sOptionHtml_FeeType = createOptions(data, 'id', 'text');
                            }
                        }
                    ])]).done(function () {
                        fnGet();
                        ...
                        $("#jsGrid1").jsGrid({
                            ...
                            fields: [
                                {// ╠common.FeeType⇒費用類別╣
                                    name: "FeeType", title: 'common.FeeType', width: 100, type: "text", validate: { validator: 'required', message: i18next.t('common.FeeType_required') },// ╠common.FeeType_required⇒請選擇費用類別╣
                                    itemTemplate: function (val, item) {
                                        return item.FeeTypeName;
                                    },
                                    insertTemplate: function (val, item) {
                                        var oControl = $('<select />', {
                                            class: "form-control w100p",
                                            html: sOptionHtml_FeeType
                                        });
                                        return this.insertControl = oControl;
                                    },
                                    insertValue: function () {
                                        if (this.insertControl.val()) {
                                            oAddItem.FeeTypeName = this.insertControl.find('option:selected').text();
                                        }
                                    ...
                                    editTemplate: function (val, item) {
                                        var oControl = $('<select />', {
                                            ...
                                            html: sOptionHtml_FeeType,
                                            change: function () {
                                                item.FeeTypeName = $(this).find('option:selected').text();
                                            }
                                        });
                                        return this.editControl = oControl.val(item.FeeType);
                                    },
                                    editValue: function () {
                                ...
                                {
                                    name: "FeeItemName", title: 'common.FeeItemName', width: 150, type: "text", validate: { validator: 'required', message: i18next.t('common.FeeItemName_required') },// ╠common.FeeItemName_required⇒請輸入費用名稱╣
                                    insertTemplate: function (val, item) {
                                        var oControl = $('<input />', {
                                            class: "form-control w100p"
                                        });
                                ...
                                {
                                    name: "BillNO", title: 'common.BillNO', width: 100, type: "text",
                                    insertTemplate: function (val, item) {
                                        var oControl = $('<select />', {
                                            class: "form-control w100p",
                                ...
                                {
                                    name: "ComplaintNumber", title: '客訴編號', width: 100, type: "text",
                                    itemTemplate: function (val, item) {
                                ...
                                {
                                    name: "PrjCode", title: 'common.PrjCode', width: 130, type: "text",
                                    itemTemplate: function (val, item) {
                                ...
                                {
                                    name: "Currency", title: 'common.Financial_Currency', width: 50, type: "text", validate: { validator: 'required', message: i18next.t('common.Currency_required') },// ╠common.Currency_required⇒請選擇幣別╣
                                    insertTemplate: function (val, item) {
                                        var oControl = $('<select />', {
                                            class: "form-control w100p",
                                            html: sOptionHtml_Currency
                                        });
                                        oControl.find('option:first').remove();
                                        return this.insertControl = oControl;
                                    },
                                    insertValue: function () {
                                        return this.insertControl.val();
                                ...
                                {
                                    name: "Amount", title: 'common.Financial_Amount', width: 70, type: "text", align: "right", validate: { validator: 'required', message: i18next.t('common.Amount_required') },// ╠common.Amount_required⇒請輸入金額╣
                                    itemTemplate: function (val, item) {
                                    ...
                                    insertValue: function () {
                                        if (this._grid.fields[4].insertControl.val() == 'NTD') {
                                    ...
                                    editValue: function () {
                                        if (this._grid.fields[4].editControl.val() == 'NTD') {
                            ...
                            controller: {
                                ...
                                insertItem: function (args) {
                                    ...
                                    args.FeeTypeName = oAddItem.FeeTypeName;
                                ...
                                updateItem: function (args) {
                                    $.each(oCurData.PayeeInfo, function (idx, _data) {
                                        if (_data.guid === args.guid) {
                                            ...
                                            _data.FeeTypeName = args.FeeTypeName;
                                        }
                                    });
                                    fnSumPayeeInfo();
                                },
