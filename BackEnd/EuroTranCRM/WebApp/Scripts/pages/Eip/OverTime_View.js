...
var sProgramId = getProgramId(),
    sQueryPrgId = 'OverTime_Qry',
    sEditPrgId = 'OverTime_Upd',
    sAction = getUrlParam('Action') || 'Add',
    sDataId = getUrlParam('Guid'),
    sCheckId = sDataId,
    fnPageInit = function () {
        var oCurData = { CheckFlows: [], HandleFlows: [], OverTimes: [] },
            oForm = $('#form_main'),
            saCheckOrder_Push = [],
            saUsers = [],
            ...
            fnCopy = function () {
                ...
                data.OverTimes = JSON.stringify(data.OverTimes);
                data.Status = 'A';
                data.IsHandled = 'N';
                data.Inspectors = '';
                data.Reminders = '';
            ...
            fnSubmitDecision = function (action) {
                ...
                g_api.ConnectLite(sEditPrgId, 'OverTimeAudit', {
                    Guid: oCurData.Guid,
                    Action: action,
                    GoNext: bGoNext ? 'Y' : 'N',
            ...
            init = function () {
                ...
                $("#jsGrid").jsGrid({
                    ...
                    fields: [
                        {
                            name: "Index", title: '#', width: 20, align: "center"
                        },
                        {
                            name: "EmployeeCode", title: 'common.EmployeeCode', width: 70, type: "text"
                        },
                        {
                            name: "EmployeeName", title: 'common.EmployeeName', width: 70, type: "text"
                        },
                        {
                            name: "OvertimeClassName", title: 'common.OvertimeClass', width: 60, type: "text"
                        },
                        {
                            name: "AttendanceDate", title: 'common.AttendanceDate', width: 70, align: "center", type: "text"
                        },
                        {
                            name: "StartDate", title: 'common.StartDate', width: 70, type: "text", align: "center"
                        },
                        {
                            name: "StartTime", title: 'common.StartTime', width: 60, type: "text", align: "center"
                        },
                        {
                            name: "EndDate", title: 'common.EndDate', width: 70, type: "text", align: "center"
                        },
                        {
                            name: "EndTime", title: 'common.EndTime', width: 60, type: "text", align: "center"
                        },
                        {
                            name: "OvertimeHours", title: 'common.OvertimeHours', width: 60, align: "center", type: "text"
                        },
                        {
                            name: "TakeTimeOffHours", title: 'common.TakeTimeOffHours', width: 60, align: "center", type: "text"
                        },
                        {
                            name: "PrjCode", title: 'common.PrjCode', width: 70, type: "text",
                            itemTemplate: function (val, item) {
                                return item.PrjCode + (!item.PrjName ? '' : '（' + item.PrjName + '）');
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            itemTemplate: function (val, item) {
                                ...
                                if (val === 'Y') {
                                    ...
                                    sVal = i18next.t("common.Nothandle");// ╠common.Nothandle⇒未經辦╣
                                }
                                else if (val === 'O') {
                                    sVal = i18next.t("common.AddOtherAudit");// ╠common.Nothandle⇒未處理╣
                                }
                                return $('<a>', { html: sVal });
                            }
                        },
