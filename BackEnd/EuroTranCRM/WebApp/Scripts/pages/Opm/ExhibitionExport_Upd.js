    ...
    fnPageInit = function () {
        ...
        var oGrid = null,
            ...
            setTime = function (that) {
                if (that.checked) {
                    $(that).parent().next().find('.date-picker').val(newDate(null, true));
                }
                else {
                ...
                switch (data.KeyName) {
                    ...
                    case 'EstimatedCost':
                        if (oTab[0].id === 'tab3') {
                            ...
                            let Current_Return_Estimatedcostsum = parseFloat((Return_Estimatedcostsum || '0').toString().replaceAll(',', '')) - iOldBoxTotal;
                    ...
                    case 'Bill':
                        ...
                        if (oTab[0].id === 'tab3') {
                            ...
                            if (data.AuditVal !== '6') {
                                ...
                                let LastRow_Return_Amountsum = parseFloat($('#tab5 .return_amountsum').val().replaceAll(',', '') - iOldBoxTotal);
                                let Current_Return_Amountsum = TabTipUntaxtotal; //TabTipTaxtotal + TabTipUntaxtotal;
                                $('#tab5 .return_amountsum').val(fMoney(LastRow_Return_Amountsum + Current_Return_Amountsum, 2, FeeItemCurrency));
                                ...
                                var oDom = [$("<a/>", {
                                    ...
                                    click: function () {
                                        ...
                                        layer.open({
                                            ...
                                            maxmin: true, //开启最大化最小化按钮
                                            area: ['90%', '80%'],
                                            content: '/Page/Pop/ExportFlowPop.html',
                                            btn: [i18next.t('common.Confirm'), i18next.t('common.Cancel')],//╠common.Confirm⇒確定╣╠common.Cancel⇒取消╣
                                            success: function (layero, index) {
                    ...
                    controller: {
                        loadData: function (args) {
							...
							$.each(saNewCustomers, function (idx, data) {
								...
								if($('#RefNumber').val() != ""){
									oAddItem.RefSupplierNo = $('#RefNumber').val() + rndnum(3);
								}
                    ...
                    .done(function (res) {
                        if (res && res[0].RESULT === 1) {
							...
							if(sAction === 'Add' && sExhibitionNO){
								...
								$("#ExportBillEName").val(saNewExhibition.Exhibitioname_EN);
