    ...
    var sLang = $('[http-equiv="content-language"]').attr('content') || 'zh-TW',
        ...
        */
        fnGetExhibitionsTop = function () {
            ...
            return g_api.ConnectLite(Service.apiwebcom, ComFn.GetExhibitionAppoint, {
                ...
                case "A":
                    {
						...
						var ApproveCBM = 0;
						if(TotalRoundedCBMs == 0){
							ApproveCBM = TotalRoundedCBMs;
						} else {
							ApproveCBM = Rule.MinCBMAmount && Rule.MinCBMAmount > AllApproveCBMs
        ...
        */
        fnGoAppoint = function () {
            ...
            if (sError) {
                ...
                window.location.href = window.location.origin + '/TE/inquiryForm' + (bEn ? '_en' : '') + '.html';
            }
        },
        init = function () {
            var myHelpers = {
