...
(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        pageSize: 20,
        pageButtonCount: 15,
        //pagerFormat: "Pages: {first} {prev} {pages} {next} {last} &nbsp;&nbsp; {pageIndex} of {pageCount} &nbsp;&nbsp;&nbsp;&nbsp; {pagepernumber}",
        pagerFormat: "{Total} {itemCount} {Pen} {first} {prev} {pages} {next} {last} &nbsp;&nbsp;&nbsp;&nbsp; {Numth} {pageIndex} {Page}  {Total} {pageCount} {Page}",
        pagePrevText: "Prev",
        pageNextText: "Next",
        pageFirstText: "First",
        pageLastText: "Last",
        ...
        invalidNotify: function (args) {
            ...
            showMsg([this.invalidMessage].concat(messages).join("<br>"), 'info');
        },
        ...
        _createRow: function (item, itemIndex) {
            ...
            $result.addClass(this._getRowClasses(item, itemIndex))
                ...
                .on("click", $.proxy(function (e) {
                    ...
                    $result.siblings().removeClass('grid-selected');
                    $result.addClass('grid-selected');
                }, this))
        ...
        _refreshPager: function () {
            ...
            if (!showPager) $pagerContainer.find('#PerPageNum').val('');
        ...
        _createPager: function () {
            ...
            if ($.isFunction(this.pagerRenderer)) {
                ...
                $result = $("<div>").append(this._createPagerByFormat()).append(['&nbsp;&nbsp;&nbsp;&nbsp;<span data-i18n="common.PerPage"></span>', $('<input/>', {// ╠common.PerPage⇒每頁╣
                    id: 'PerPageNum',
                ...
                }), '<span data-i18n="common.Pen"></span>']);// ╠common.Pen⇒筆╣
            }
        ...
        _createPagerByFormat: function () {
            ...
            return $.map(pagerParts, $.proxy(function (pagerPart) {
                ...
                if (pagerPart === PAGES_PLACEHOLDER) {
                    ...
                    result = itemCount;
                } else if (pagerPart === '{Total}') {
                    result = '<span data-i18n="common.Total"></span>';// ╠common.Total⇒共╣
                } else if (pagerPart === '{Pen}') {
                    result = '<span data-i18n="common.Pen"></span>';// ╠common.Pen⇒筆╣
                } else if (pagerPart === '{Numth}') {
                    result = '<span data-i18n="common.Numth"></span>';// ╠common.Numth⇒第╣
                } else if (pagerPart === '{Page}') {
                    result = '<span data-i18n="common.Page"></span>';// ╠common.Page⇒頁╣
                }
        ...
        _refreshHeight: function () {
            ...
            if (height !== "auto") {
                ...
                this._body.outerHeight(height - (nonBodyHeight === 0 ? 90 : nonBodyHeight));
            }
        },
        ...
        loadData: function (filter) {
            ...
            return this._controllerCall("loadData", filter, args.cancel, function (res) {
                if (!res) {
                    return;
                }
                var _data = {},
                ...
                if (res.itemsCount >= 0) {
                    ...
                    if (res[0]) { res = res[0]; }
                    if ((res.RESULT !== undefined && !res.RESULT) || (res.d !== undefined && !res.d)) {
                        return;
                    }
                    ...
                    if (res.RESULT !== undefined) {
                        ...
                        _data = JSON.parse(res.d);
                    }
                    loadedData = {
                        data: _data.DataList,
                        itemsCount: _data.Total
                    };
                }
        ...
        _updateRow: function ($updatingRow, editedItem) {
            ...
            return this._controllerCall("updateItem", updatedItem, args.cancel, function (res) {
                var loadedUpdatedItem = !res || typeof res.DATA.rel !== 'object' ? undefined : res.DATA.rel,
        ...
        deleteItem: function (item) {
            ...
            if (this.confirmDeleting) {
                layer.confirm(getOrApply(this.deleteConfirm, this, $row.data(JSGRID_ROW_DATA_KEY)), { icon: 3, title: i18next.t('common.Tips') }, function (index) {
                    layer.close(index);
                    //debugger;
                    return _this._deleteRow($row);
                });
            }
...
(function (jsGrid, $, undefined) {
    ...
    DirectLoadingStrategy.prototype = {
        ...
        lastDisplayIndex: function () {
            ...
            var itemsCount = grid.option("total").length;//John modified
        ...
        itemsCount: function () {
            ...
            //debugger;
            return this._grid.option("total").length;//John modified
        },
...
(function (jsGrid, $, undefined) {
    ...
    TextField.prototype = new Field({
        ...
        _createTextBox: function () {
            return $("<input>").attr("type", "text").attr("class", "form-control w100p")
...
(function (jsGrid, $, undefined) {
    ...
    NumberField.prototype = new TextField({
        ...
        _createTextBox: function () {
            return $("<input>").attr("type", "number").attr("class", "form-control w100p")
                .prop("readonly", !!this.readOnly);
        }
    });
