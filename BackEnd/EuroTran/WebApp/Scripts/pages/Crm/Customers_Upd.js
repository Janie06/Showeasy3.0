...
var fnPageInit = function () {
    var sLang = g_ul.GetLang(),
            ...
            pageInit: function (pargs) {
                ...
                $("#jsGrid").jsGrid({
                    ...
                    fields: [
                        ...
                        {
                            name: "Exhibitioname_TW", title: 'Exhibition_Upd.Exhibitioname_TW', width: 600,
                            itemTemplate: function (val, item) {
                                var oA = $('<a>', {
                                    html: sLang === 'zh' ? item.Exhibitioname_CN : val,
                                    class: 'a-url',
                                    click: function () {
                                        parent.top.openPageTab('Exhibition_Upd', '?Action=Upd&SN=' + item.SN);
                                    }
                                });
                                return oA;
                            }
        ...
        fnGetGridData = function () {
            if (canDo.ids.guid) {
                return g_api.ConnectLite(canDo.ProgramId, 'GetExhibitionlist', {
                    Guid: canDo.ids.guid
                });
            }
            else {
