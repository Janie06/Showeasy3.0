...
var sProgramId = getProgramId(),
    sQueryPrgId = 'InvoiceApplyForPersonal_Qry',
    sEditPrgId = 'InvoiceApplyForPersonal_Upd',
    ...
    fnPageInit = function () {
        var oCurData = { CheckFlows: [], HandleFlows: [], PayeeInfo: [] },
            ...
            fnSubmitDecisionForAll = function () {
                ...
                g_api.ConnectLite(sEditPrgId, 'InvoiceApplyForPersonalAuditAll', {
                    Guid: oCurData.Guid,
            ...
            fnSubmitDecision = function (action) {
                ...
                g_api.ConnectLite(sEditPrgId, 'InvoiceApplyForPersonalAudit', {
                    Guid: oCurData.Guid,
                    Action: action,
                    GoNext: bGoNext ? 'Y' : 'N',
            ...
            init = function () {
                    ...
                    fnSetArgDrop([
                        {
                            ArgClassID: 'Currency',
                            CallBack: function (data) {
                                $('#RemittanceInformation_TotalCurrencyTW,#RemittanceInformation_TotalCurrency').html(createOptions(data, 'id', 'id'))[0].remove(0);
                            }
                        }
                    ])])
                    .done(function () {
                ...
                $("#jsGrid").jsGrid({
                    ...
                    fields: [
                        {
                            name: "FeeTypeName", title: 'common.FeeType', width: 100, type: "text"
                        },
                        {
                            name: "FeeItemName", title: 'common.FeeItemName', width: 250, type: "text"
                        },
                        {
                        ...
                        {
                            name: "PrjName", title: 'common.PrjCode', width: 210, type: "text",
                            itemTemplate: function (val, item) {
