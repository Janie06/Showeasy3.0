...
var sProgramId = getProgramId(),
    sQueryPrgId = 'BillChangeApply_Qry',
    sEditPrgId = 'BillChangeApply_Upd',
    sAction = getUrlParam('Action') || 'Add',
    sDataId = getUrlParam('Guid'),
    sCheckId = sDataId,
    fnPageInit = function () {
        var oCurData = { CheckFlows: [], HandleFlows: [], BillChanges: [] },
            oForm = $('#form_main'),
            saCheckOrder_Push = [],
            saUsers = [],
            ...
            fnSubmitDecision = function (action) {
                ...
                g_api.ConnectLite(sEditPrgId, 'BillChangeApplyAudit', {
                    Guid: oCurData.Guid,
                    Action: action,
                    GoNext: bGoNext ? 'Y' : 'N',
            ...
            fnSubmitDecisionForAll = function () {
                var data = getFormSerialize(oForm);
                g_api.ConnectLite(sEditPrgId, 'BillChangeApplyAuditAll', {
                    Guid: oCurData.Guid,
            ...
            init = function () {
                ...
                $.whenArray([
                    ...
                    fnSetUserDrop([
                        {
                            Select: $('#BillChanges_ResponsiblePerson'),
...
require(['base', 'formatnumber', 'jsgrid', 'jqprint', 'filer', 'common_eip', 'util'], fnPageInit);