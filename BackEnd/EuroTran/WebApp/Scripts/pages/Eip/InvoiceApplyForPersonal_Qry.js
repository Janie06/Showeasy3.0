                        ...
                        CallBack: function () {
                            ...
                            $("#jsGrid").jsGrid({
                                ...
                                fields: [
                                    ...
                                    { name: "ApplicantName", title: 'common.Applicant', width: 70, align: 'center' },
                                    {
                                        name: "PayeeInfo", title: 'common.FeeItems', width: 200, itemTemplate: function (val, item) {
                                            var saOverTimes = $.parseJSON(val),
                                                sOverTimes = Enumerable.From(saOverTimes).ToString("，", "$.FeeItemName");
                                            return sOverTimes;
                                        }
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        name: "CheckFlows", title: 'common.CurAuditor', width: 100, itemTemplate: function (val, item) {
                                            ...
                                            if (sCurAuditor === '') {
                                                ...
                                                if (saCheckFlows.length > 0 && saCheckFlows[0].SignedDecision !== 'Y') {
