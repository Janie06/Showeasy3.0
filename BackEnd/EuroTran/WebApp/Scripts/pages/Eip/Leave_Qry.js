                        ...
                        CallBack: function () {
                            ...
                            $("#jsGrid").jsGrid({
                                ...
                                fields: [
                                    ...
                                    { name: "AskTheDummyName", title: 'common.AskTheDummy', width: 70, align: 'center' },
                                    { name: "Agent_PersonName", title: 'common.AgentPerson', width: 70, align: 'center' },
                                    {
                                        name: "StartDate", title: 'common.StartDate', width: 90, align: 'center', itemTemplate: function (val, item) {
                                            return newDate(val);
                                        }
                                    },
                                    {
                                        name: "EndDate", title: 'common.EndDate', width: 90, align: 'center', itemTemplate: function (val, item) {
                                            return newDate(val);
                                        }
                                    },
