...
{
    ///<summary>
    /// 注意:20190722 跟Carli確認後。該功能出差申請合併到請假申請中。
    ///      資料請繼續留存。
    ///</summary>
    [SugarTable("OTB_EIP_BusinessTravel")]
    public partial class OTB_EIP_BusinessTravel : ModelContext
    {
           public OTB_EIP_BusinessTravel(){
